import { AccommodationCreateUpdateDTO, AccommodationInfo, BookingBaseURL } from '@frontend/models';
...
export async function CreateUpdateAccommodationFunction(
  data: AccommodationCreateUpdateDTO,
  amenities: string[],
  images: string[],
  hostId: string
): Promise<void> {
