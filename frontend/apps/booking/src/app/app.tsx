...
import { MyReservationsPageContainer, ReservationPageContainer } from '@frontend/features/booking/reservation/container';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path={BookingAppRoutes.MyReservations} element={<MyReservationsPageContainer />} />
        <Route path={BookingAppRoutes.AccomodationReservation} element={<ReservationPageContainer />} />
      </Routes>
    </>
  );
}
