...
var file_auth_service_auth_service_proto_rawDesc = []byte{
	...
	0x13, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x14, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x44, 0x65, 0x6c, 0x65,
...
var file_auth_service_auth_service_proto_depIdxs = []int32{
	...
	6, // 3: auth.AuthService.Delete:input_type -> auth.DeleteRequest
	1, // 4: auth.AuthService.Login:output_type -> auth.LoginResponse
	3, // 5: auth.AuthService.Register:output_type -> auth.RegisterResponse
	5, // 6: auth.AuthService.Update:output_type -> auth.UpdateResponse
	7, // 7: auth.AuthService.Delete:output_type -> auth.DeleteResponse
