...
const (
	...
	AccommodationService_GetAllForHostByAccommodationId_FullMethodName        = "/accommodation.AccommodationService/GetAllForHostByAccommodationId"
)
...
type AccommodationServiceClient interface {
	...
	GetAllForHostByAccommodationId(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetAllForHostByAccommodationIdResponse, error)
}
...
func (c *accommodationServiceClient) GetAllForHostByAccommodationId(ctx context.Context, in *GetByIdRequest, opts ...grpc.CallOption) (*GetAllForHostByAccommodationIdResponse, error) {
	out := new(GetAllForHostByAccommodationIdResponse)
	err := c.cc.Invoke(ctx, AccommodationService_GetAllForHostByAccommodationId_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccommodationServiceServer interface {
	...
	GetAllForHostByAccommodationId(context.Context, *GetByIdRequest) (*GetAllForHostByAccommodationIdResponse, error)
...
func (UnimplementedAccommodationServiceServer) GetAllForHostByAccommodationId(context.Context, *GetByIdRequest) (*GetAllForHostByAccommodationIdResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetAllForHostByAccommodationId not implemented")
}
...
func _AccommodationService_GetAllForHostByAccommodationId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetByIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccommodationServiceServer).GetAllForHostByAccommodationId(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccommodationService_GetAllForHostByAccommodationId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccommodationServiceServer).GetAllForHostByAccommodationId(ctx, req.(*GetByIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccommodationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetAllForHostByAccommodationId",
			Handler:    _AccommodationService_GetAllForHostByAccommodationId_Handler,
		},
	},
